...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:HyperLink ID="logout" CssClass="link" NavigateUrl="~/login.aspx" runat="server">Logout</asp:HyperLink>
              ...
              <table id="tblFormTable" CellSpacing="20" runat="server"  >
                ...
                <tr>
                    ...
                    <td>
                     ...
                     <asp:ListBox ID="junior" runat="server" CssClass="drop2" AutoPostBack="True"  OnSelectedIndexChanged="ListBox1_SelectedIndexChanged" SelectionMode="Multiple"></asp:ListBox>
                     <asp:ListBox ID="senior" runat="server" CssClass="drop2" AutoPostBack="True" OnSelectedIndexChanged="ListBox1_SelectedIndexChanged" SelectionMode="Multiple"></asp:ListBox>
                     <asp:ListBox ID="techlead" runat="server" CssClass="drop2" AutoPostBack="True" OnSelectedIndexChanged="ListBox1_SelectedIndexChanged" SelectionMode="Multiple"></asp:ListBox>             
                ...
                <tr>
                    ...
                    <td>
                     ...
                     <Triggers>
                     <asp:AsyncPostBackTrigger ControlID="junior" EventName="SelectedIndexChanged" />
                     <asp:AsyncPostBackTrigger ControlID="senior" EventName="SelectedIndexChanged" />
                     <asp:AsyncPostBackTrigger ControlID="techlead" EventName="SelectedIndexChanged" />
